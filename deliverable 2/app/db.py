            ...
            conn.executemany(
                ...
                [
                    (
                        ...
                        "Smartphones",
                        999.00,
                        "Apple flagship with titanium frame and A17 Pro chip",
                    ),
                    (
                        "MacBook Air M3",
                        "Laptops",
                        1299.00,
                        "Fanless Apple silicon laptop, 18-hour battery",
                    ),
                    (
                        "Samsung Galaxy S24",
                        "Smartphones",
                        799.00,
                        "Android flagship with Galaxy AI features",
                    ),
                    (
                        "Sony WH-1000XM5",
                        "Audio",
                    ...
                    (
                        ...
                        "Audio",
                        249.00,
                        "Apple earbuds with adaptive transparency",
                    ),
                    (
                        "Dell XPS 15",
                        "Laptops",
                        1599.00,
                        "OLED 4K display, Intel Core i9, RTX 4060",
                    ),
                    (
                        "iPad Pro M4",
                        "Tablets",
                        1099.00,
                        "Ultra-thin Apple tablet with M4 chip",
                    ),
                    (
                        "Google Pixel 8",
                        "Smartphones",
                        699.00,
                        "Pure Android, 7 years of updates, Tensor G3",
                    ),
                    (
                        "Bose QuietComfort 45",
                        "Audio",
                        279.00,
                        "Comfortable ANC headphones, 24h battery",
                    ),
                    (
                        "Microsoft Surface Pro 9",
                        "Tablets",
                        999.00,
                        "Detachable Windows 11 Pro tablet with LTE option",
                    ),
                ],
            )
        ...
        if conn.execute("SELECT COUNT(*) FROM users").fetchone()[0] == 0:
            ...
            demo_users = [
                (
                    1,
                    "alice",
                    generate_password_hash("Alice@1234"),
                    "user",
                    1,
                    now,
                    None,
                    ...
                    "Alice's private notes - confidential project planning",
                ),
                (
                    2,
                    "bob",
                    generate_password_hash("Bob@1234"),
                    "user",
                    1,
                    now,
                    None,
                    ...
                    "Bob's notes - upcoming interview schedule",
                ),
                (
                    3,
                    "charlie",
                    generate_password_hash("Charlie@1234"),
                    "user",
                    1,
                    now,
                    None,
                    ...
                    "Charlie's notes - sensitive customer data",
                ),
                (
                    4,
                    "diana",
                    generate_password_hash("Diana@1234"),
                    "user",
                    1,
                    now,
                    None,
                    ...
                    "Diana's notes - personal financial records",
                ),
            ]
